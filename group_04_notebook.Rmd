...
all_payouts_decade <- read_csv('data/finalized_clean_10_year_payouts.csv', skip=2, col_names =c("fiscal_year", "case_name", "claim_case_number", "amount", "department", "case_type"))
...
((369018871+4733024)/880687820)*100
